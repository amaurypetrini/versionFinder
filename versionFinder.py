#!/usr/bin/env python
# versionFinder - Based on secretFinder & linkFinder - Tool for discover version of technology in js file
# based on LinkFinder - github.com/GerbenJavado
# By m4ll0k (@m4ll0k2) github.com/m4ll0k
# By AmauryPetrini github.com/amaurypetrini
...
<head>
  ...
  <title>versionFinder Output</title>
</head>
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r","--regex",help="RegEx for filtering purposes against found endpoint (e.g: ^/v1.0/)",action="store")
